...
const getConfig1 = mod3.getConfig({
    ...
    "base-url": {
        "name": "Base URL",
        "description": "Public URL of your ntfy server (your Tor .onion or LAN HTTPS URL, e.g. https://ntfy.local). Required for attachment links and web push to resolve correctly.",
        "type": "string",
        "nullable": true,
        "masked": false,
        "copyable": false
    ...
    "attachment-total-size-limit": {
        ...
        "description": "Maximum total disk usage for all attachments, in megabytes",
        "type": "number",
        "nullable": false,
        "integral": true,
        "range": "[100,1000000]",
    ...
    "visitor-attachment-limit": {
        ...
        "description": "Maximum total attachment storage per visitor, in megabytes",
        "type": "number",
        "nullable": false,
        "integral": true,
        "range": "[10,100000]",
    ...
    "cache-duration": {
        ...
        "description": "How long messages and attachments are retained, in hours",
        "type": "number",
        "nullable": false,
        "integral": true,
        "range": "[1,8760]",
...
const dependencies = {};
const migration = async (_effects, _version)=>{
    return {
        result: {
            configured: true
        }
